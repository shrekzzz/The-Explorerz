...
import { MapPin, Calendar, IndianRupee, Sparkles, ArrowRight, ArrowLeft, Minus, Plus } from "lucide-react";
...
const steps = [
  ...
  { id: "budget",      label: "Budget",      icon: IndianRupee, color: "from-emerald-500 to-teal-400" },
          ...
          {step === 2 && (
            <div className="space-y-5">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Total budget for the entire trip (INR).</p>
              </div>
              {/* Presets */}
