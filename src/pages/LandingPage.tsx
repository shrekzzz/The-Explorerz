...
import { Plane, MapPin, Sparkles, IndianRupee, Calendar, ArrowRight, Star, Mountain, Hotel, TrainFront, TreePine, Waves, Building2, CloudSun } from "lucide-react";
...
const features = [
  ...
  { icon: IndianRupee, title: "Budget Tracking", desc: "Stay on budget with automatic cost estimation and breakdown.", gradient: "from-amber-500 via-orange-400 to-yellow-500", bgGradient: "from-amber-500/10 via-orange-400/5 to-yellow-500/10" },
